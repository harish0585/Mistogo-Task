    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar style={{ background: "#FFFFFF" }}>
          ...
          <NotificationsNoneIcon onClick={handleClick2} style={{color: "black"}}/> &nbsp; &nbsp;
          <Menu
        id="simple-menu"
        anchorEl={anchorEl2}
        keepMounted
      ...
      >
        <MenuItem onClick={handleClose2} style={{width: "350px"}}>
            <div style={{display: "flex", justifyContent: "space-between", width: "350px"}}>
                ...
                <div>
                    <div style={{fontWeight: 600}}>Bavid Kames</div>
                    <p>Assigned you to sara</p>
                </div>
                <div>2 min ago</div>
            </div>
        </MenuItem>
      ...
      <Button aria-controls="simple-menu" aria-haspopup="true" onClick={handleClick}>
        John Doe {anchorEl ? <ExpandMoreIcon /> : <ExpandLessIcon />} <Avatar alt="Remy Sharp" src="/static/images/avatar/1.jpg" />
      </Button>
      <Menu
        id="simple-menu"
        anchorEl={anchorEl}
        ...
        style={{marginTop: "50px"}}
      >
        <MenuItem onClick={handleClose}><PermIdentityIcon /> &nbsp; My Profile</MenuItem>
        <MenuItem onClick={handleClose}><AssignmentIcon /> &nbsp; Billing</MenuItem>
